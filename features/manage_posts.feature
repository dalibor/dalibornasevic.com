Feature: Manage Blog posts
  ...
  Scenario: Admin lists blog posts in administration
  ...
  Scenario: Admin creates valid blog post
    Given I have no posts
    And I am logged in
    And I am on list of blog posts in administration
  ...
  Scenario: Admin created invalid blog post
    Given I have no posts
    And I am logged in
    And I am on new blog post in administration
    When I press "Create"
    And I should see "Title can't be blank"
    And I should see "Content can't be blank"

  Scenario: Admin edits blog post
  ...
  Scenario: Admin deletes blog post
    Given I have created posts titled Cucumber, Webrat, Vim, Git
    And I am logged in
    And I am on list of blog posts in administration
    When I follow "Webrat"
